...
class TagInitTest
{
	public:
		void test(void)
		{
			...
			tree<HTML::Node> tr;
			HTML::ParserDom parser;
			std::string TagInitTest_filename("TagInitTest");
			parser.parse(html, TagInitTest_filename);
			tr = parser.getTree();
//			cerr << reference << endl;
//			cerr << tr << endl;
...
class ParseAttrTest
{
	public:
		bool test()
		{
			...
			tree<HTML::Node> t;
			HTML::ParserDom parser;
			std::string ParseAttrTest_filename("ParseAttrTest");
			parser.parse(html, ParseAttrTest_filename);
			t = parser.getTree();
