...
ostream & operator<<(ostream & out, Arbitrator & a) {
  ...
  out<<"***********result detail**************"<<endl;
    ...
    out<<"hit rate: "<< (hit[H_NULL] + hit[H_URL] + hit[H_JS] + hit[H_TK])/num<<endl;
    out<<"total detected: "<<a._checker._detectUrlCount<<endl;
    out<<"deduped url:" <<a._detector.getDedup()<<endl;
    out<<"dtime: "<<dtime/num/1000.0<<"ms"<<endl;
    out<<"jstime: "<<jstime/num/1000.0<<"ms"<<endl;
    out<<"tktime: "<<tktime/num/1000.0<<"ms"<<endl;
    out<<"ftime: "<<ftime/num/1000.0<<"ms"<<endl;
    out<<"svmtime: "<<svmtime/num/1000.0<<"ms"<<endl;
    out<<"processtime: "<<ptime/num/1000.0<<"ms"<<endl;
    out<<"puretime: "<<pureptime/num/1000.0<<"ms"<<endl;
